"""Test latency and TTFT of pixel:fast model directly."""
...
def test_pixel_fast(prompt: str):
...
if __name__ == "__main__":
    for i in range(5):
        ...
        test_pixel_fast("Hello, who are you?")
        test_pixel_fast("Explain the difference between synchronous and asynchronous code in 2 sentences")
